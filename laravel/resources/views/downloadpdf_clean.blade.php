...
<body>
    ...
    <div class="page">
        @php($logoPath = str_replace('\\', '/', public_path('img/career-preference-logo.jpg')))
        @if(file_exists($logoPath))
            <img src="{{ $logoPath }}" class="title-logo" alt="Career Preference">
        @endif
        <div class="title-sub">The Preferred Career Test Online</div>

        <div class="spacer-md"></div>

        <table class="identity-block">
            <tr>
                <td style="width:50%;">
        ...
        <table class="score-table">
            @foreach ($scores as $score)
                ...
                <tr>
                    <td class="score-label">{{ $score->name }}</td>
                    <td>
                        <div class="score-bar-bg">
                            <div class="score-bar-fill" style="width: {{ $percent }}%;"></div>
                        </div>
                    </td>
                    <td class="score-number">{{ $score->value }}</td>
                </tr>
            @endforeach
        </table>
        ...
        <table class="summary-table" style="width:auto;">
            <tr>
                <td class="summary-title-cell"></td>
                @foreach ($scores as $score)
                    @if ($loop->index < 3)
            ...
            <tr>
                <td class="summary-title-cell">Score</td>
                @foreach ($scores as $score)
                    @if ($loop->index < 3)
    ...
    <div class="page">
        ...
        <div class="hex-wrap">
            @php($hexPath = str_replace('\\', '/', public_path('img/riasec_hexagon_holland.jpg')))
