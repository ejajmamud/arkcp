          ...
          <div class="col-12 hero-text-image">
            <div class="row">
              <div class="col-lg-6 text-center text-lg-left">
                ...
                <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Sit for our online Career Indicator (CI) assessment and explore career options that are compatible with your interests, skills, values, and personality. Get started and let you career take off !</p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-8" data-aos="fade-up">
            <h2 class="section-heading">USD 8.90 / MYR 37.00</h2>
          </div>
        </div>
