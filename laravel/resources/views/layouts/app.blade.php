...
<head>
    ...
    <link rel="icon" type="image/png" sizes="96x96"
          href="{{ asset('storage/blogassets/'.$settings->favicon ?? '') }}">
    ...
    <style>
        .brand-logo-text{
            ...
            background: linear-gradient(90deg, #227DC7, #F28621, #0B617E, #227DC7);
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 col-lg-3">
                        <a href="{{ url('/') }}" class="mb-0">
                            <h1 class="my-3 site-logo" style="margin:0;">
                                <span class="brand-logo-text">Free Career Test</span>
                            </h1>
                        </a>
                ...
                <div class="col-12 col-md-9 d-none d-lg-block">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        ...
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li><a href="{{route('registration.store')}}" class="btn btn-menu">Start Career Test</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 mb-4 mb-md-0">
              ...
              <p>
                  Career Preference Test is an initiative of Ark Publications; a career guidance resources publisher, organizers of higher education exhibitions & training, and trusted career consultants based in Kuala Lumpur Malaysia since 1984.
              </p>
...
<div class="col-md-4 mb-4 mb-md-0">
  <h3 style="font-family: sans-serif; font-size: 20px; color: #fff;">Follow Us</h3>
  <p class="social" style="margin: 0; display: flex; align-items: center; gap: 12px;">

    <a href="http://facebook.com/careerpreference" target="_blank" style="
      display: inline-block;
      width: 48px;
      height: 48px;
