        ...
        <div class="container">
          <div class="row py-5 align-items-center">
                <div class="col-lg-6 pr-lg-5 text-center text-lg-left">
                  ...
                  <a href="https://ark.com.my/product/career-preference-career-test/" class="btn btn-primary">Start Career Test</a>
                  
                </div>
                <div class="col-lg-6">
                  <img src="{{ asset('laravel/storage/banner/'.$banner ?? '') }}" alt="Image" class="img-fluid" >
                </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-3 text-center text-md-right">
            <p> <a href="https://ark.com.my/product/career-preference-career-test/" class="btn"><span class="icofont-ui-play mr-3"></span>Start Career Test</a></p>
          </div>
        </div>
      </div>
