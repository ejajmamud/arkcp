...
<body>
    ...
    if ( isset($pdf) ) {
        ...
        $pdf->page_text(480, 814, "Page: {PAGE_NUM} of {PAGE_COUNT}", $font, 8, array(0,0,0));
    }
</script>
                        ...
                        <tr>
                            <td>
                                ...
                                @if(file_exists($logoPath))
                                    <img src="{{ $logoPath }}" style="max-width:250px">
                                @endif
                                <h4 style="margin:7px 0;font-size:16px">The Preferred Career Test Online</h4>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table>
                        <tr>
                            <td colspan="2" style="padding-bottom:10px">
                                <h2 style="margin-top:5px">Career Test Report</h2>
                            </td>
                        </tr>
                        <tr class="user-details-rw">
                            <td style="padding-right:6%">
                                <table class="user-details itm-list">
                                    <tr>
                                        <td>Name</td>
                                        <td data-label="Name" class="capitalize">: <b>{{$user->firstname}}
                                                {{$user->lastname}}</b></td>
                                    </tr>
                                    <tr>
                                        <td>Age</td>
                            ...
                            <td style="padding-right:6%">
                                <table class="user-details itm-list">
                                    ...
                                    <tr>
                                        <td>Test Date</td>
                                        <td data-label="Test Date">: <b>
                                                {{ date('d-m-Y', strtotime($user->updated_at)) }} </b></td>
                                    </tr>
                                    <tr>
                                        <td>Country</td>
                                        <td data-label="Test ID" class="capitalize">: <b>{{$user->country}} </b></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <td colspan="2">
                    <div>
                        ...
                        <p>The Career Assessment report provides you with possible career options that you can
                            explore based on the summary code (3 letters) generated above based on your test
                    ...
                    <div>
                        <h3 style="margin-top:0">Overview of Holland’s RIASEC types</h3>
                    ...
                    <div>
                        ...
                        <p>RIASEC letters can be used to describe the personality type a person’s interest most
                            ...
                            different
                            interest.
                            Below are the characteristic and important information about the six types. Think about how
                            it
                            relates
                ...
                <td colspan="2">
                    ...
                    <div class="hex-img">
                        ...
                        @if(file_exists($hexPath))
                            <img src="{{ $hexPath }}" alt="" style="max-width:30%">
                        @endif
                    </div>
                    <div class="ps-info">
                        <h4>REALISTIC</h4>
                        <p>
                            Realistic people tend to have athletic interests, prefer to work with objects, machines,
                            tools, plants or animals, and like to be outdoors.
                        </p>
                        <p> <span class="theme-color">Characteristics:</span> Independent, Practical, Systematic,
                            Self-Controlled, and Straightforward
                            <br> <span class="theme-color">Working Environment:</span> Agriculture, Construction,
                            Manufacturing, Distribution, Transport, Shipping and Aviation
                        </p>
                    </div>
                    <div class="ps-info">
                        <h4>INVESTIGATIVE </h4>
                        ...
                        <p> <span class="theme-color">Characteristics:</span> Logical, Curious, Thoughtful, Observant,
                            and Intellectual
                            <br> <span class="theme-color">Working Environment:</span> Academic Education, IT,
                            Healthcare and Innovative Companies
                        </p>
                    </div>
                    <div class="ps-info">
                        <h4>ARTISTIC</h4>
                        <p>
                            Artistic people like to work in unstructured situations using their imagination and
                            creativity
                        </p>
                        <p> <span class="theme-color">Characteristics:</span> Creative, Imaginative, Unconventional,
                            Expressive, Innovative, and Impulsive
                            <br> <span class="theme-color">Working Environment:</span> Advertising, Music &
                            Entertainment industry, Theatre, Art sector and at companies
                    ...
                    <div class="ps-info">
                        ...
                        <p> <span class="theme-color">Characteristics:</span> Patient, Insightful, Responsible,
                            Cooperative, Outgoing, and Skilled with words
                            <br> <span class="theme-color">Working Environment:</span> Government, Education, Health
                    ...
                    <div class="ps-info">
                        <h4>ENTERPRISING </h4>
                        <p>
                            Enterprising people like to work with people to influence, persuade and lead them, and to
                            achieve organizational or financial goals.
                        </p>
                        <p> <span class="theme-color">Characteristics:</span> Assertive, Energetic, Persuasive,
                            Ambitious, Optimistic
                            <br> <span class="theme-color">Working Environment:</span> Management, Sales & Marketing,
                    ...
                    <div class="ps-info">
                        <h4>CONVENTIONAL</h4>
                        <p>
                            Conventional people like to work with information, carry out detailed tasks, and have
                            clerical or numerical interests.
                        </p>
                        <p> <span class="theme-color">Characteristics:</span> Efficient, Well-Organized, Persistent,
                            Methodical, or Conscientious
                            <br> <span class="theme-color">Working Environment:</span> Banking & Finance, Management &
            ...
            <tr>
                <td colspan="2">
                    <div>
                        ...
                        <p>
                            Below are the jobs for your 3 highest summary codes. The first letter of your code
                            represents the careers most
                            suitable for your personality type. The second letter represents the next careers most
                            suitable for your personality
                            type and so on. The types not included in the three summary codes are careers least suitable
                            for your personality
                            type.
                        </p>
                        <p>You can print (a PDF report has also been sent to your email provided) and go through the
                            careers listed below
                            and tick / highlight careers that you have interest in and mark a question mark for those
                            that you are interested in
                            but need to research for more information.
                        </p>
                        <p>Explore if the careers match your own dream careers. Narrow down your career choices and
                            research them in detail.
                            If the careers suggested does not match your interest, don’t quickly change your plans.
                            Instead, do some
                            investigation to make sure you understand the career you have chosen and those suggested in
                            this report. No single
                            test or resource can provide you with “one” right choice. Only you can make your career
                            decision. All the best in
                            your future!
                        </p>
                    </div>
                </td>
                ...
                <td colspan="2">
                    <table>
                        <tbody>
                            <tr>
                                <td colspan="2">
                                    <h2 style="margin-top:25px"><b>Exploring Occupations</b></h2>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="occupation-group">
                                            <h4 style="text-transform:uppercase;font-weight:normal">{{$key}} OCCUPATIONS
                                            </h4>
                                            ...
                                            <table class="occupation-table">
                                                @foreach($occupationRows as $row)
                                                    <tr>
                                                        <td>
                                                            @if(isset($row[0]))
                                                                &bull; {{$row[0]->occupationen}}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if(isset($row[1]))
                                                                &bull; {{$row[1]->occupationen}}
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
            ...
            <tr>
                <td colspan="2">
                    <div>
                        <h3>Next Step</h3>
                        <p>
                            Identify and highlight those careers that may interest you (about 10-15 careers). You may
                            not be
                            familiar with some of the careers, don’t worry, circle it and research about it later. You
                            can do your
                            research by reading books, searching online, reaching out to your network and finding out
                            from those
                            who are working in the industry, familiarizing yourself with the career of your choice,
                            volunteering or
                            getting a temp job in the field you are interested in, attending career fairs and seminars
                            or interviewing
                            industry professionals. Find out as much as you can about those careers that interests you
                            and
                        ...
                        <ul>
                            ...
                            <li>What are the trends that could influence the demand in the future?</li>
                            <li>Will there be local jobs in that field, or will you have to relocate?</li>
                            <li>What skills, education & training, languages and experience are required in that field?
                            </li>
                        ...
                        <p>
                            Step 2 : Go to <a href="https://www.onetonline.org/"
                                target="_blank">https://www.onetonline.org/</a>
                        </p>
                        <p>
                            Step 3: Search for information about the ten careers you have short-listed and read about
                            all ten careers.
                        </p>
                        <p>
                            Step 4: After reading about the ten careers, you may drop a few of them. Your list may get
                            shorter.
                        </p>
                        <p>
                            Step 5: Search for universities that offer courses in the fields that you have selected.
                            Explore the entry requirements, tuition fees, duration of the course, etc.
                        </p>
                        <p>
                            Step 6: Apply to the universities when applications are invited. Once the university issues
                            an offer letter, start to make the necessary preparations.
                        </p>
                        <p>
                            If you are in doubt or need further career guidance, write to : <a
                                href="mailto:enquiry@ark.com.my">enquiry @ark.com.my</a>. Our Career Coach will provide
                            you all the necessary assistance you need. This service is provided FREE to all those who
